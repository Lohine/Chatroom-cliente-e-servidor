...
def send():
    ...
    if destinatario.get() != "" and mensagem.get() != "":
        ...
        client_socket.send(bytes(msg, "utf8"))        
        msg_list.insert(tkinter.END, "Para: " + msg_split[1])
        msg_list.insert(tkinter.END, "Assunto: " + msg_split[2])
        msg_list.insert(tkinter.END, "Mensagem: " + msg_split[3])
        msg_list.insert(tkinter.END, " ")
    elif mensagem.get() != "":
        ...
        mensagem.set("")  # limpa o campo de mensagem
        client_socket.send(bytes(msg, "utf8"))        
        msg_list.insert(tkinter.END, "Para: Todos")
        msg_list.insert(tkinter.END, "Assunto: " + msg_split[2])
        msg_list.insert(tkinter.END, "Mensagem: " + msg_split[3])
        msg_list.insert(tkinter.END, " ")
...
l_remetente = tkinter.Label(window, text="   NickName:", font="Ubuntu 14", width=11, height=2, bg="#ffffff")
...
#Colocar o ip do Host do servidor do radmin
HOST = "26.211.32.12" 
PORT = 50000
if not PORT:
    PORT = 50000
